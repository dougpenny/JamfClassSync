...
def main():
    ...
    for jamf_class in existing_classes:
        ...
        if success:
            ...
            logging.info(f"Tried to delete class with ID {class_id} from Jamf, but was unsuccessful. Will try again.")
    ...
    if len(delete_retires) > 0:
        ...
        for delete_id in delete_retires:
            ...
            if success:
                ...
                logging.warning(f"Tried to delete class with ID {delete_id} from Jamf, but was unsuccessful. This class may need to be deleted manually.")
